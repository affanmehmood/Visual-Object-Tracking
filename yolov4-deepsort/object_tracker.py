...
flags.DEFINE_string('video', './data/video/cars1.mp4', 'path to input video or set to 0 for webcam')
flags.DEFINE_string('output', "outputs/cars1.avi", 'path to output video')
